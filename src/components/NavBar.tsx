...
export function NavBar() {
  ...
  return (
    <nav
      className="nav-gradient fixed top-0 left-0 right-0 z-50 h-16 flex items-center px-4 gap-1"
      style={{ backdropFilter: "blur(16px)", WebkitBackdropFilter: "blur(16px)" }}
    >
      <Link href="/" className="mr-3 flex items-center gap-2 flex-shrink-0">
